...
**완료 2026-04-11**. 18개 후보 전부 dynesty nested sampling 완료.
병렬 실행: 배치1 9개 (A01,A05,A12,A17,A03,A06,A08,A09,A11) +
배치2 6개 (A13,A15,A16,A19,A20,C11D) + 기존 3개(LCDM,C28,C33).

**결과 요약** (LCDM ln Z = −843.689 기준):

| 순위 | ID   | ln Z     | Δ ln Z  | Jeffreys    | Q8  | K14 |
|------|------|----------|---------|-------------|-----|-----|
| 1    | C28  | −832.432 | +11.257 | **STRONG**  | ✓   | —   |
| 2    | A17  | −832.909 | +10.780 | **STRONG**  | ✓   | —   |
| 3    | A12  | −832.910 | +10.779 | **STRONG**  | ✓   | —   |
| 4    | A01  | −832.999 | +10.690 | **STRONG**  | ✓   | —   |
| 5    | A05  | −833.108 | +10.581 | **STRONG**  | ✓   | —   |
| 6    | A06  | −833.115 | +10.574 | **STRONG**  | ✓   | —   |
| 7    | A16  | −833.135 | +10.554 | **STRONG**  | ✓   | —   |
| 8    | A20  | −833.389 | +10.300 | **STRONG**  | ✓   | —   |
| 9    | A03  | −833.566 | +10.123 | **STRONG**  | ✓   | —   |
| 10   | A09  | −833.679 | +10.010 | **STRONG**  | ✓   | —   |
| 11   | A08  | −834.054 |  +9.635 | **STRONG**  | ✓   | —   |
| 12   | C11D | −834.738 |  +8.951 | **STRONG**  | ✓   | —   |
| 13   | A13  | −835.032 |  +8.657 | **STRONG**  | ✓   | —   |
| 14   | A15  | −835.975 |  +7.714 | **STRONG**  | ✓   | —   |
| 15   | A11  | −836.409 |  +7.280 | **STRONG**  | ✓   | —   |
| 16   | A19  | −839.229 |  +4.460 | substantial | ✓   | —   |
| 17   | C33  | −841.181 |  +2.508 | substantial | ✓   | —   |

**핵심 발견**:
- **K14 탈락 후보 없음** (전원 Δ ln Z > −1)
- **Q8 전원 통과** (Δ ln Z ≥ +2.5, 17/17)
- **alt-hard 4종 (A01,A05,A12,A17): Δ ln Z ≈ +10.6~10.8**, C28(+11.3)와
  동급 STRONG — 0-파라미터가 1-파라미터와 같은 증거를 낸다는 §8 기록 확인
- **C11D: Δ ln Z = +8.951** — 3D 파라미터 Occam 패널티 부담 후에도 STRONG
- **Alt-soft cluster (A03,A06,A08,A09,A11,A13,A15,A16,A19,A20): +4.5~+10.6**
  — A19 만 substantial, 나머지 전부 STRONG
- **C33: +2.508** — substantial borderline; S_8 3중 실패(L5-D)와 합산해 demoted
  status 유지. arXiv submission 제외.

산출: `simulations/l5/evidence/evidence_all.json`
...
|------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| C11D | ✓   | ✓   | **+8.951 STRONG** | ≈2.9σ est | ✓   | ✓   | ✓   | **YES main** |
| C28  | ✓   | ✓   | **+11.257 STRONG** | 3.91σ    | ✓   | ✓   | ✓   | **YES main** |
| A12  | ✓   | ✓   | **+10.779 STRONG** | 2.16σ    | ✓   | ✓   | ✓   | **YES alt-rep** |
| A17  | ✓   | ✓   | **+10.780 STRONG** | 2.75σ    | ✓   | ✓   | ✓   | backup |
| A04  | △   | ✓   | not run (weak Δχ²) | 7.98σ  | ✓   | ✓   | ✓   | **watch** |
| C33  | ✓   | **✗** K15 | +2.508 substantial | 3.12σ    | **✗** | **✗** | ✓ | **NO demoted** |
| C26  | ✗   | —   | —         | 0σ       | —   | —   | —   | **NO killed** |

**Q8 완료 (2026-04-11)**: 전 후보 K14 없음, 전원 Q8 통과.
